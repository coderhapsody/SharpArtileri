<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterTerms.aspx.cs" Inherits="SharpArtileri.Web.MasterTerms" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">            
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetAllTerms" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </asp:View>
