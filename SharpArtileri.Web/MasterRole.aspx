<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterRole.aspx.cs" Inherits="SharpArtileri.Web.MasterRole" StylesheetTheme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">            
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetAllRoles" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </asp:View>
