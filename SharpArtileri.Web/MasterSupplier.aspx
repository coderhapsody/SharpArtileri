<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="MasterSupplier.aspx.cs" Inherits="SharpArtileri.Web.MasterSupplier" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View runat="server" ID="viwRead">
            <fieldset>
                <table class="fullwidth">
                    <tr>
                        ...
                        <td><telerik:RadTextBox runat="server" ID="txtFindName"></telerik:RadTextBox> </td>
                    </tr>
                    <tr>
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetAllSuppliers" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
        ...
        <asp:View runat="server" ID="viwAddEdit">
            ...
            <table class="fullwidth">
                 <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtCode" ValidationGroup="AddEdit" Width="100px" MaxLength="5"></telerik:RadTextBox>
                        <asp:RequiredFieldValidator ID="rqvCode" runat="server" ControlToValidate="txtCode" CssClass="errorMessage" Display="Dynamic" EnableViewState="False" ErrorMessage="&lt;b&gt;Code&lt;/b&gt; must be specified" SetFocusOnError="True" ValidationGroup="AddEdit" />
                    </td>
                </tr>
                <tr>
