<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="TrxPurchaseOrderRejection.aspx.cs" Inherits="SharpArtileri.Web.TrxPurchaseOrderRejection" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View ID="viwRead" runat="server">
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetPurchaseOrdersForApproval" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
        ...
        <asp:View ID="viwAddEdit" runat="server">
            ...
            <br />
            <br />
                     <telerik:RadButton runat="server" ID="btnVoid" AutoPostBack="false" EnableViewState="false" CausesValidation="False" Text="Void" OnClientClicking="btnVoidClick"></telerik:RadButton>
            &nbsp;&nbsp;&nbsp;
            <script>
