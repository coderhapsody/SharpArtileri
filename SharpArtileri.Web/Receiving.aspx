<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterWorkspace.Master" CodeBehind="Receiving.aspx.cs" Inherits="SharpArtileri.Web.Receiving" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View ID="viwRead" runat="server">
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetReceivings" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
                                    ...
                                    <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:HyperLink runat="server" ID="hypLookUpPO" ImageUrl="Images/zoom.png" ToolTip="Look up Purchase Order" onclick="showPromptPopUp('PromptPurchaseOrder.aspx?Code=cphMainContent_hidPOID&Name=ctl00_cphMainContent_txtDocumentPO', null, 550, 900);"></asp:HyperLink>
