...
namespace SharpArtileri.Web
{
    public partial class TrxPurchaseOrder : BaseForm
    {
        ...
        private void FillDropDown()
        {
            ...
            ddlTerms.DataSource = TermService.GetTerms();
        ...
        private void LoadData()
        {
            ...
            dtpDate.SelectedDate = poHeader.Date;
            ...
            if (poHeader.VoidDate.HasValue || poHeader.Status == "N" || poHeader.Status == "A")
            {
        ...
        {
            cboItem.DataSource = ItemService.GetItems(e.Text);
        ...
        protected void cboItem_SelectedIndexChanged(object sender, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        {
            try
            {
                var units = ItemService.GetUnitsOfItem(Convert.ToInt32(e.Value));
        ...
        protected void btnAddDetail_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                try
                {
                    ...
                    detailLine.IsTaxed = item.IsTaxed;
        ...
        private void GetDefaultPrice()
        {
                ...
                !String.IsNullOrEmpty(ddlUnit.SelectedText))
            {
                try
                {
                    var defaultPrice = ItemService.GetDefaultPrice(
                        Convert.ToInt32(cboSupplier.SelectedValue),
