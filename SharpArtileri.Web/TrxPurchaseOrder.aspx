<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterWorkspace.Master" AutoEventWireup="true" CodeBehind="TrxPurchaseOrder.aspx.cs" Inherits="SharpArtileri.Web.TrxPurchaseOrder" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    <asp:MultiView runat="server" ID="mvwForm">
        <asp:View ID="viwRead" runat="server">
            ...
            <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetPurchaseOrders" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
                <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; text-align: left; vertical-align: top;">
                            <asp:UpdatePanel runat="server" ID="uppSupplierInformation" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <artileri:SupplierInformation ID="SupplierInformation" runat="server" />
                                </ContentTemplate>
                                <Triggers>
                    ...
                    <table class="fullwidth">
                        ...
                        <tr>
                            <td class="auto-style12">
                                <telerik:RadComboBox runat="server" ID="cboItem" AutoPostBack="true" EnableLoadOnDemand="true" Width="300px" ShowDropDownOnTextboxClick="false" MarkFirstMatch="true" HighlightTemplatedItems="True" EnableVirtualScrolling="true" OnItemsRequested="cboItem_ItemsRequested" OnSelectedIndexChanged="cboItem_SelectedIndexChanged">
                                    <HeaderTemplate>
                                        <ul>
