<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPrompt.Master" CodeBehind="PromptPurchaseOrder.aspx.cs" Inherits="SharpArtileri.Web.PromptPurchaseOrder" StylesheetTheme="Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <asp:SqlDataSource ID="sdsMaster" runat="server" SelectCommand="proc_GetPurchaseOrdersForReceiving" SelectCommandType="StoredProcedure" OnSelecting="sdsMaster_Selecting">
        <SelectParameters>
